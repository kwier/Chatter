...
(defn generate-message-view
              ...
              (page/html5
               [:head
                [:title "chatter"]
                (page/include-css "//maxcdn.bootstraphcdn.com/bootstrap/3.3.1/css/bootstrap.min.css")
                (page/include-js "//maxcdn.bootstraphcdn.com/bootstrap/3.3.1/js/bootstrap.min.js")
